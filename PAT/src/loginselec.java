 ...
 * @author Vansh Chawla
 */
public class loginselec extends javax.swing.JFrame {

    /**
     * Creates new form loginselec
     */
    public loginselec() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gupta Tuck Shop Login");

        buttonGroup1.add(managercheck);
        managercheck.setFont(new java.awt.Font("Helvetica Neue", 0, 36)); // NOI18N
        managercheck.setSelected(true);
        managercheck.setText("Admin");
        ...
        admincheck.setFont(new java.awt.Font("Helvetica Neue", 0, 36)); // NOI18N
        admincheck.setText("Manager");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // TODO add your handling code here:
            ...
            this.setVisible (false); // Sets this frame to be invisible
            ManagerLogin p = new ManagerLogin();
            p.setVisible(true); 
        }
        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loginselec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new loginselec().setVisible(true);
        });
    }
